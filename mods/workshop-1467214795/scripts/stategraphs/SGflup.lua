...
local states=
{
    ...
    State{
        ...
        onenter = function(inst)
            ...
            inst.Physics:Stop()
            --inst:Hide()
            inst.AnimState:HideSymbol("ground_fx")
            inst.AnimState:HideSymbol("flupt_tail")
            inst.AnimState:HideSymbol("flup_tongue")
            inst.AnimState:HideSymbol("flup_mouth")
            inst.AnimState:HideSymbol("flup_fin")
            inst.AnimState:HideSymbol("flup_eye")
            inst.AnimState:HideSymbol("flup_body")
            inst.AnimState:HideSymbol("flup_antenna")
        ...
        onexit = function(inst)
            --inst:Show()
            inst.AnimState:ShowSymbol("ground_fx")
            inst.AnimState:ShowSymbol("flupt_tail")
            inst.AnimState:ShowSymbol("flup_tongue")
            inst.AnimState:ShowSymbol("flup_mouth")
            inst.AnimState:ShowSymbol("flup_fin")
            inst.AnimState:ShowSymbol("flup_eye")
            inst.AnimState:ShowSymbol("flup_body")
            inst.AnimState:ShowSymbol("flup_antenna")
            inst.DynamicShadow:Enable(true)
            ChangeToCharacterPhysics(inst)
        end,
    },
...
CommonStates.AddHopStates(states, true, {loop = "jump"})
