return {
	ACTIONFAIL = {
		...
		READ =
		{
			...
			VOLCANO = "The birds are fearful of this harsh climate.",
		},
	},
	...
	ANNOUNCE_TREASURE_DISCOVER = "Behold! Gold.",
	...
	DESCRIBE = {
		...
		WOBSTERBISQUE = "I'd almost forgotten what real food tasted like.",
        WOBSTERDINNER = "How decadent.",
		...
		IA_MESSAGEBOTTLE = "I am intrigued!",
		IA_MESSAGEBOTTLEEMPTY = "I do like when there is a manuscript inside.",
		...
		WINDSTAFF = "I can use this to my advantage in a storm.",
		...
		IA_TRIDENT = "A tool of ancient legend.",
		...
		CHESSPIECE_KRAKEN = "There was no reference for the lower half of the Octopode.",
		...
		--SWC
		BOAT_SURFBOARD = "She downplays the amount of skill and craftsmanship it takes to use it.",
		SURFBOARD_ITEM = "She downplays the amount of skill and craftsmanship it takes to use it.",
