...
local _RebuildLayout = UpvalueHacker.GetUpvalue(InventoryBar.Rebuild, "RebuildLayout")
...
UpvalueHacker.SetUpvalue(InventoryBar.Rebuild, RebuildLayout, "RebuildLayout")