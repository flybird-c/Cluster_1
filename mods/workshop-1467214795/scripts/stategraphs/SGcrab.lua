...
local function PlayCrabFootstep(inst)
    ...
    if sound then
        ...
        if tile == WORLD_TILES.FLOOD or tile == WORLD_TILES.MARSH or tile == WORLD_TILES.MUD then
            sound:PlaySound("ia/creatures/crab/walk_mud")
            return
        end

        if tile == WORLD_TILES.FUNGUS or tile == WORLD_TILES.FUNGUSRED or tile == WORLD_TILES.FUNGUSGREEN then
            sound:PlaySound("ia/creatures/crab/walk_moss")
            return
        end

        if tile == WORLD_TILES.GRASS then
        ...
        if tile == WORLD_TILES.CARPET then
            sound:PlaySound("ia/creatures/crab/walk_carpet")
            return
        end

        if tile == WORLD_TILES.ROAD or tile == WORLD_TILES.ROCKY or tile == WORLD_TILES.CHECKER or 
        tile == WORLD_TILES.VOLCANO or tile == WORLD_TILES.UNDERROCK or tile == WORLD_TILES.BRICK_GLOW or tile == WORLD_TILES.BRICK then
...
State{
    ...
    if inst:HasTag("crab_hidden") then inst.sg:AddStateTag("noattack") end
