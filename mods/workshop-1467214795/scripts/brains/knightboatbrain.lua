...
function KnightBoatBrain:OnStart()
    local root = PriorityNode(
    {
        ...
        WhileNode(function() return self.inst.raider and (self.inst.components.combat.target == nil or not self.inst.components.combat:InCooldown()) end,
            "Raid", ChaseAndAttack(self.inst, MAX_CHASE_TIME)),
        WhileNode(function() return not self.inst.raider and (self.inst.components.combat.target == nil or not self.inst.components.combat:InCooldown()) end,
