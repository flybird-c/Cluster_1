...
WarnQuakeScheduleLong =
{
	{segsprev = 8},
	{segsprev = 16}
}

WarnQuakeScheduleShort =
{
	{segsprev = 2},
	{segsprev = 4}
}
...
VolcanoSchedule = {DrySeasonSchedule = VolcanoDrySeasonSchedule, StaffTrapSchedule = VolcanoStaffTrapSchedule}
