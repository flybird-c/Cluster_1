...
local IA_FERTILIZER_DEFS = {}

IA_FERTILIZER_DEFS.spoiled_fish_large = {nutrients = TUNING.SPOILED_FISH_LARGE_NUTRIENTS}
IA_FERTILIZER_DEFS.mysterymeat = {nutrients = TUNING.MYSTERYMEAT_NUTRIENTS}
...
for fertilizer, data in pairs(IA_FERTILIZER_DEFS) do
    ...
    if fertilizer and data then
        ...
        local sort_data = ia_sort_order[fertilizer]
