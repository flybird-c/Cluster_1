...
local ground_types = {
	...
	WORLD_TILES.VOLCANO, WORLD_TILES.VOLCANO_LAVA, WORLD_TILES.ASH, WORLD_TILES.VOLCANO_ROCK, --48, 49, 50, 51
...
AllLayouts["CoffeeBushBunch"].ground_types = ground_types
...
-- 	scale = 1,
-- }
AllLayouts["Terrarium_Jungle_Fire"] = StaticLayout.Get("map/static_layouts/terrarium_jungle_fire", {
	border = 1,
	start_mask = PLACE_MASK.IGNORE_IMPASSABLE_BARREN,
	fill_mask = PLACE_MASK.IGNORE_IMPASSABLE_BARREN,
	layout_position = LAYOUT_POSITION.CENTER,
...
AllLayouts["Terrarium_Jungle_Snakes"] = StaticLayout.Get("map/static_layouts/terrarium_jungle_snakes", {
	border = 1,
	start_mask = PLACE_MASK.IGNORE_IMPASSABLE_BARREN,
	fill_mask = PLACE_MASK.IGNORE_IMPASSABLE_BARREN,
	layout_position = LAYOUT_POSITION.CENTER,
...
AllLayouts["Terrarium_Jungle_Spiders"] = StaticLayout.Get("map/static_layouts/terrarium_jungle_spiders", {
	border = 1,
	start_mask = PLACE_MASK.IGNORE_IMPASSABLE_BARREN,
	fill_mask = PLACE_MASK.IGNORE_IMPASSABLE_BARREN,
	layout_position = LAYOUT_POSITION.CENTER,
...
AllLayouts["LivingJungleTree"].ground_types = ground_types
...
AllLayouts["WallyIntroDebris"] = StaticLayout.Get("map/static_layouts/wallyintro_debris", {
	border = 1,
	start_mask = PLACE_MASK.IGNORE_IMPASSABLE_BARREN,
	fill_mask = PLACE_MASK.IGNORE_IMPASSABLE_BARREN,
	layout_position = LAYOUT_POSITION.CENTER,
