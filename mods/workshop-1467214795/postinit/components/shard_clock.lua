...
IAENV.AddComponentPostInit("shard_clock", function(self, inst)
    local _world = TheWorld
    ...
    if _world.ismastershard then
        ...
        local _remainingtimeinphase = UpvalueHacker.GetUpvalue(OnClockUpdate, "_remainingtimeinphase")
