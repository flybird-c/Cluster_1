...
local function onattack(inst, data)
    ...
    inst.sg:HasStateTag("busy")) then
        ...
        if dist > TUNING.PALMTREEGUARD_MELEE * TUNING.PALMTREEGUARD_MELEE * (scale * scale) then
            --Throw
            inst:SetRange()
...
local states=
{
	...
	State{
        ...
        timeline=
        {
            ...
            TimeEvent(15*FRAMES, function(inst) inst.SoundEmitter:PlaySound("ia/creatures/palm_tree_guard/attack_swipe") end),
