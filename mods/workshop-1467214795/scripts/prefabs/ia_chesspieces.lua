...
local PIECES =
{
    {name="kraken",			moonevent=false,    gymweight=4},
    {name="tigershark",		moonevent=false,    gymweight=4},
    {name="twister",		moonevent=false,    gymweight=4},
    {name="seal",			moonevent=false,    gymweight=4},
}
