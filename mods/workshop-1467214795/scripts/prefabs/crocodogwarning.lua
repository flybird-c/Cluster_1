--the way its done in ia_warnings.lua doesnt work -half
...
local function PlayWarningSound(inst, radius)
    ...
    inst.SoundEmitter:PlaySound("ia/creatures/crocodog/distant")
    inst:Remove()
end
...
for level, distance in ipairs(WARNING_LEVEL_DISTANCE) do
    table.insert(t, Prefab("crocodogwarning_lvl"..level, makewarning(distance)))
end
return unpack(t)
