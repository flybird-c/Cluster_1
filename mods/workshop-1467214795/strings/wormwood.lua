...
ANNOUNCE_TREASURE_DISCOVER = "Hidden stuff nearby",
...
DESCRIBE = {
	...
	WOBSTERBISQUE = "Still snappy?",
    WOBSTERDINNER = "For belly",
	...
	IA_MESSAGEBOTTLE = "Says something...",
	IA_MESSAGEBOTTLEEMPTY = "Aw. Nothing inside",
	...
	BARREL_GUNPOWDER = "BOOM Barrel",
	ROCK_CHARCOAL = "Burnt rock",
	ROCK_OBSIDIAN = "Hard",
	WINDSTAFF = "Blow Stick",
	...
	CHESSPIECE_KRAKEN = "Angry beaker still tweeting? No?",
	...
	--SWC
	BOAT_SURFBOARD = "Puny Floater",
	SURFBOARD_ITEM = "Puny Floater is floating",

	WALANI = {
		GENERIC = "Oh. %s is sleepy",
		ATTACKER = "Bad %s!",
		MURDERER = "Bad %s! Don't kill!",
		REVIVER = "%s is good",
		GHOST = "%s is sleepy floaty",
		FIRESTARTER = "Too much fire, %s! Get water!",
	},

	WILBUR = {
		GENERIC = "Hello Leggy Hairy friend!",
		ATTACKER = "No! Stop hurting!",
		MURDERER = "Bad %s! Made friends not alive",
		REVIVER = "%s is friend fixer",
		GHOST = "Oh. Hello, Floaty Friend! Where hair go?",
		FIRESTARTER = "Fire bad, %s!",
	},

	WOODLEGS = {
		GENERIC = "%s is Arrg friend",
		ATTACKER = "Don't hurt, %s!",
		MURDERER = "Killing bad, %s! Killing bad!",
		REVIVER = "%s is nice Arrg friend",
		GHOST = "Like being floaty, %s?",
		FIRESTARTER = "Aggh! Arrg made too much fire!",
	},
},
}
