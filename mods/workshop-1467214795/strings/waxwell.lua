return {
	ACTIONFAIL = {
		...
		READ =
		{
			...
			VOLCANO = "They're fearful of its power.",
		},
	},
	...
	ANNOUNCE_TREASURE_DISCOVER = "Ah! I sense another treasure to find.",
	...
	DESCRIBE = {
        ...
        WOBSTERBISQUE = "Ah, I do enjoy the finer things.",
        WOBSTERDINNER = "Finally, something to suit my refined palate.",
		...
		IA_MESSAGEBOTTLE = "What is this primitive communication?",
		IA_MESSAGEBOTTLEEMPTY = "Given enough time I could build a ship inside.",
		...
		WINDSTAFF = "A stick, presumably for sailing.",
		...
		IA_TRIDENT = "A fork fit for ocean royalty.",
		...
		CHESSPIECE_KRAKEN = "It'll make a fearsome addition to my base.",
		...
		--SWC
		BOAT_SURFBOARD = "Looks much too precarious for my liking.",
		SURFBOARD_ITEM = "Looks much too precarious for my liking.",
		...
		WALANI = {
            ...
            GHOST = "We will require a heart to bring you back, %s. But that's work, yes?",
		...
		WILBUR = {
            ...
            REVIVER = "%s is an effective ally... That's the best one could say of a monkey.",
            GHOST = "%s needs heart-shaped assistance in some form.",
		...
		WOODLEGS = {
            ...
            GHOST = "Do you desire a heart like treasure, %s?",
